...
public class CustomerController {
	...
	//public String addCustomer(@RequestParam Optional<String> firstname, Model model)
      public String addCustomer(@RequestParam String firstname, Model model)
   // public String addCustomer(@RequestParam(required = false) String firstname, Model model)
   // public String addCustomer(@RequestParam(defaultValue = "it") String firstname, Model model)
	{
